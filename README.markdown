...
1. Install the gem:
   ...
   Or pull the container down using Docker:
        ...
        > docker build --pull -t pivotal-to-trello .

   When using the docker container, substitute every occurance of `pivotal-to-tracker` with `sudo docker run -it pivotal-to-tracker`
